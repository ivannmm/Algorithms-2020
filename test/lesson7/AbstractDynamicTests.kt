...
Наследник всех своих родных.
    ...
    fun longestIncreasingSubSequence(longestIncreasingSubSequence: (List<Int>) -> List<Int>) {
        ...
        assertEquals(listOf(1,2,3,9,10,11), longestIncreasingSubSequence(listOf(1,2,3,9,10,11,4,5,6)))
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        assertEquals(232, shortestPathOnField("input/field_in5.txt"))
        assertEquals(15, shortestPathOnField("input/field_in6.txt"))
        assertEquals(146, shortestPathOnField("input/field_in7.txt"))
        assertEquals(85, shortestPathOnField("input/field_in8.txt"))
    }
